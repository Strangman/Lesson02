...
namespace Task3
{
    ...
    class Figure
    {
        ...
        public virtual void setPerimetr()
        {
            perimetr = 3 * side1;
        }
    ...
    class Circle: Figure
    {
        ...
        {
            perimetr = 3.14 * Math.Pow(side1, 2);
        }
        public override void getInfo()
        {
            Console.WriteLine("name: " + name + " colore: " + colore + " Area: " + perimetr);
        }
    }
    class Triangle: Figure
    {
        public override void getInfo()
        {
            Console.WriteLine("name: " + name + " colore: " + colore + " Perimetr: " + perimetr);
        }
    }
    class Square: Figure
    {
